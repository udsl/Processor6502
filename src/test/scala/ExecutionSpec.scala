...
//  (InsData(0x69, 126, 0), InsResultData(226,0,0, UNUSED_FLAG_MASK | OVERFLOW_FLAG_MASK | NEGATIVE_FLAG_MASK)), // ADC immediate 126
  (InsData(0x65, 101, 0),  InsResultData(106, 0, 0, UNUSED_FLAG_MASK)) // ADC zer0 page 101 contains 6
...
val dataAndInstructionTest = List(
  (InsData(0x29, 0xF4, 0), InsResultData(4, 0, 0, UNUSED_FLAG_MASK)) // And accumulator (100) result should be 4
