...
object NumericFormatSelector:
  ...
  var instances: Seq[NumericFormatSelector] = List[NumericFormatSelector]()
...
class NumericFormatSelector extends VBox:
  ...
  numericalFormatGroup.selectToggle(numericalFormatGroup.toggles.head)
